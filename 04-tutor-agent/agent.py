...
4. MANEJO DE INTERFAZ: El usuario tiene el código pegado en una barra lateral que se te enviará repetidamente en cada mensaje. Si el usuario te pide "sigue", "continúa" o te hace una pregunta de seguimiento, IGNORA el [CÓDIGO ADJUNTO] de ese turno y simplemente mantén la conversación o termina tu idea anterior.
