...
def load_resources():
    try:
        pipe = joblib.load('models/model_pipeline.pkl')
        pca = joblib.load('models/model_pca.pkl')
        gmm = joblib.load('models/model_gmm.pkl')
        cols = joblib.load('models/model_cols.pkl')
        db = pd.read_csv('db/songs_database.csv')
